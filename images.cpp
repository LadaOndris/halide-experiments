...
int main(int argc, char **argv) {
    ...
    unsigned char *data = stbi_load("images/bird.jpg", &width, &height, &nrChannels, 0);
    if (!data) {
    ...
    Halide::Buffer<uint8_t> input(data, width, height, nrChannels);
    ...
    stbi_write_png("output.png", width, height, nrChannels, outputData, width * nrChannels);
